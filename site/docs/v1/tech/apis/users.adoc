...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Create a User with a randomly generated Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Create a User with the provided unique Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve a User by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve a User by login Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve a User by email
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve a User by username
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve a User by Change Password Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve a User by Email Verification Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=fas]] Retrieve a User using a JWT
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Update the User with the given Id
[.endpoint]
.URI
--
...
:api_endpoint: pass:normal[/api/user/`\{userId\}`]
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Deactivate a User (Soft Delete)
[.endpoint]
.URI
--
...
--
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Permanently Delete a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Deactivate Users by User Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Deactivate Users by Search Query String
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Deactivate Users by Raw JSON Search Query
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Permanently Delete Users by User Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Permanently Delete Users by Search Query String
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Permanently Delete Users by Raw JSON Search Query
[.endpoint]
.URI
--
...
The Elasticsearch query string that is used to search for Users to be deleted. The [field]#userId#, [field]#query#, and [field]#queryString#  parameters are mutually exclusive, they are listed here in order of precedence.

[field]#userId# [type]#[UUID]# [optional]#Optional#::
The Id of the User to delete. Repeat this parameter for each user to be deleted. The [field]#userId#, [field]#query#, and [field]#queryString#  parameters are mutually exclusive, they are listed here in order of precedence.

include::docs/v1/tech/apis/_x-fusionauth-tenant-id-header-scoped-operation.adoc[]

[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Bulk delete using the request body. This allows for larger requests than are possible using request parameters.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Reactivate the User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Import Multiple Users
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Search for Users by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Search for Users by a query string
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Search for Users by a query string and sort the response
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red]] Search for Users by a raw JSON query
[.endpoint]
.URI
--
...
The Elasticsearch query string that used to search for Users. Using this parameter is mutually exclusive with the [field]#ids# and [field]#query# fields.
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Search for Users using a JSON request body. This allows for larger requests than are possible using request parameters.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Retrieve recent logins
[.endpoint]
.URI
--
[method]#GET# [uri]#/api/user/recent-login``?limit=\{limit\}&offset=\{offset\}&userId=\{userId\}``#
--
...
The link:/docs/v1/tech/reference/data-types#instants[instant] this login occurred.
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Verifies the User's email address using the `verificationId`.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Resend the verification email
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Resend the verification email using an API key
[.endpoint]
.URI
--
...
The email verification Id that was generated by this API request. This identifier may be used by the <<verify-a-users-email,Verify a User's Email>> API.
...
By default the `changePasswordId` is valid to be used with the link:#change-a-users-password[Change Password] API for 10 minutes. If a `404` is returned when using this Id to change the password, the workflow
...
You may optionally authenticate this request with an API key to allow for some additional request parameters and the generated `changePasswordId` will be returned in the JSON body. This may be helpful if you wish to use your own email system or you have an alternative method to call the link:#change-a-users-password[Change Password] API.
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock[role=green,type=fas]] Start the forgot password workflow without an API Key.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Start the forgot password workflow using an API key
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/user/forgot-password#
...
The optional change password Id to be used on the <<change-a-users-password,Change a User's Password>> API.
+
...
|403
|The forgot password functionality has been disabled. This is caused by an administrator setting the Forgot Password Email Template to the option _Feature Disabled. No template selected._ in the Tenant Email configuration. See [breadcrumb]#Tenants -> Email -> Teplate settings# in the FusionAuth admin UI.
...
The change password Id that was generated by this API request. This identifier may be used by the <<change-a-users-password,Change Password>> API. This field is only returned in the JSON response body if the request was authenticated using an API key, if an API key is not used no response body is returned.
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Changes a User's password using an email address or username.
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=fas]] Changes a User's password using a JWT
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=fas]] Flushes the Search Engine
[.endpoint]
.URI
--
